...
/*$q="select * from (
    ...
    $q="SELECT * from stockScan WHERE stockscan_numProd like '%{$numProd}%' and ((stockscan_typeStock>=50 and stockscan_typeStock<60) || (stockscan_typeStock>=500 and stockscan_typeStock<600))";
    //echo $q;
